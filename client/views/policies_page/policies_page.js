...
var PoliciesPageViewExport = function(fileType) {
	var extraParams = {
		...
		searchFields: Session.get("PolicyListPagedSearchFields") || ["id", "gp_id", "group_policy_id", "phone_no", "premium_amount", "sum_insured_amount", "activation", "payments", "payout.total_amount", "payout.deductible_amount", "payout.actual_amount", "bc.next_action"],
		sortBy: Session.get("PolicyListPagedSortBy") || "",
		sortAscending: Session.get("PolicyListPagedSortAscending") || true
	};

	var exportFields = ["id", "gp_id", "group_policy_id", "phone_no", "premium_amount", "sum_insured_amount", "payout.total_amount", "payout.deductible_amount", "payout.actual_amount"];
