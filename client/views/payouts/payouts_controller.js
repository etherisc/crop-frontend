this.PayoutsController = RouteController.extend({
	...
	data: function() {
		...
		var data = {
			params: this.params || {},
			payout_list_paged: XPayouts.find(databaseUtils.extendFilter({}, this.payoutListPagedExtraParams), databaseUtils.extendOptions({}, this.payoutListPagedExtraParams)),
