...
Template.PayoutsHeader.created = function() {

};

Template.PayoutsHeader.destroyed = function() {

};

Template.PayoutsHeader.rendered = function() {

};

Template.PayoutsHeader.helpers({

});

Template.PayoutsHeader.events({
...
var PayoutsViewExport = function(fileType) {
	var extraParams = {
		...
		searchFields: Session.get("PayoutListPagedSearchFields") || ["order_number", "GermDry", "GermWet", "VegDry", "Flower", "ExcessRain", "Total", "Actual", "execute", "executed"],
...
Template.PayoutsView.events({
	...
	"click #dataview-insert-button": function(e, t) {
		e.preventDefault();
		Router.go("payouts.insert", mergeObjects(Router.currentRouteParams(), {}));
	},
...
Template.PayoutsViewTableItems.events({
	...
	"click #edit-button": function(e, t) {
		e.preventDefault();
		Router.go("payouts.update", mergeObjects(Router.currentRouteParams(), {payoutId: this._id}));
		return false;
	}
});
...
Template.PayoutsViewCustomActions.created = function() {

};

Template.PayoutsViewCustomActions.destroyed = function() {

};

Template.PayoutsViewCustomActions.rendered = function() {

};

Template.PayoutsViewCustomActions.helpers({

});

Template.PayoutsViewCustomActions.events({
	"click #btn-execute": function (e,t) {
		e.preventDefault();
