...
var ActivationsPageViewExport = function(fileType) {
	...
	var exportFields = ["prefix", "mobile_num", "call_time", "latitude", "longitude", "order_number", "activation_code", "value_chain", "amount_premium", "pixel", "county", "ward", "augmented", "amount_subsidy", "planting_date"];
