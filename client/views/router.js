...
Router.map(function () {
	...
	this.route("/group_policies/details/:groupPolicyId/details/:groupPolicyId/:policyId", {name: "group_policies.details.details", title: "Group Policies", controller: "GroupPoliciesDetailsDetailsController"});
